...
export const storeProducts = [
  ...
  },
  {
    ...
    days:5,
    info:
      " Located at a distance of just 51 kilometres from the main town, Rohtang Pass can be reached only by road. The pass is located at a massive height of 3978 metres, the way up the hills is a treat to the eyes. As the vehicle climbs higher on the Manali- Keylong road, the beauty of the landscape around will leave you awestruck.",
    inCart: false,
    count: 0,
    total: 0
  },
